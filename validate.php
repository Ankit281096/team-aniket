...
$c=mysqli_connect($host,$username);
$query = mysqli_query($c,"SELECT * FROM `health_centre_details` WHERE `Username`=$Username");
if($query=="false")
    $count=0;
else
$count = 1;
...
$query= "INSERT INTO `health_centre_details`(`Centre Name`,`Address`,`Email`,`Username`,`Password`) VALUES ('$name','$address','$email','$Username','$password')";
		...
		<div class="container">
			<div class="row main">
				...
				<input type ="radio" name="registration" value="customer "  id ="button2" >Customer -->
					...
					<form class="" method="post" action="validate.php">
						...
						<div class="form-group ">
                                                    <a href="validate.php" target="_blank" type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Register</a>
						</div>
	<h5> <?php if(($error)){
           ...
           echo "<a style=color:white; href=login.php>Click here to login</a>";
