...
$c2=mysqli_select_db($c,$database);
    $query=mysqli_query($c," SELECT `Username`,`Password` FROM `health_centre_details` WHERE `Username` LIKE '$Username' AND `Password` LIKE '$password'");
...
<html lang="en">
	...
	<body>
		...
		<div class="container">
           ...
           $msg="Login Successful           " ;echo $msg; 
           echo "<a style=color:white; href=user_dashboard.php>Click here to continue.</a>";
           }?></h5>
					</form>
				</div>
			</div>
